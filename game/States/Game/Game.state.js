...
export class GameState extends State {
    ...
    configureBoard() {
        ...
        this.board.initialize(this.camera.element, new Vector2(this.dataMap.width, this.dataMap.height), new Vector2(this.dataMap.tilesets[0].tilewidth, this.dataMap.tilesets[0].tileheight));
    }
    configurePlayer() {
